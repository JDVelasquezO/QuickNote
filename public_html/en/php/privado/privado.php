...
?>
    ...
    <div class="container">
        <div id="perfil" class="row">
            <div class="col s12 m6">
              <div class="card">
                ...
                <div class="card-content">
                    <p>
                        What's up <?=$_SESSION['nombre']?>, We are working so that a few days you can put a small description about you, in this space ... Espéralo
                    </p>
                </div>
                <div class="card-action">
                    <a href="perfil.php?id=<?=$id?>">Profile</a>
                </div>
              </div>
            </div>
            ...
            <div class="col s12 m6">
                <ul class="collection">
                  <li class="collection-item cyan accent-4" style="color: #fff;">Notes:</li>
            ...
            <div class="fixed-action-btn toolbar">
                ...
                <ul>
                  <li class="waves-effect waves-light"><a href="usuarios.php">Our community</a></li>
                  <li class="waves-effect waves-light"><a href="blogs.php">Publications</a></li>
                </ul>
            </div>
    ...
    <a class="btn tooltipped cyan accent-4" data-position="bottom" data-delay="50" data-tooltip="Post" href="form.php">
        <i class="large material-icons">chrome_reader_mode</i>
    </a>
    <a class="btn tooltipped cyan accent-4" data-position="bottom" data-delay="50" data-tooltip="Chat Online" href="indexChat.php">
    ...
    <form action="buscarPerfil.php" method="post">
            <div class="row">
                <div class="input-field col s12">
                    ...
                    <label for="icon_prefix">Search profile:</label>
                </div>
    ...
    <h5><a href="privacidad.php?id=<?=$_SESSION['id']?>">Privacy</a></h5>
