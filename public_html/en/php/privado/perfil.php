            ...
            <div id="formContacto3" class="row center">
                <div class="row">
                    <form method="post" action="insertarimg.php" enctype="multipart/form-data">
                        ...
                        <div>
                            <div class="input-field col s12">
                                <button class="btn waves-effect waves-light cyan accent-4" type="submit" name="action">Update your photo
                    ...
                    <form action="editar.php" method="post">
                        <h3 class="blue-text">Your personal information</h3>
                        <br><br><br>
                        <input type="hidden" name="id" value="<?= $fila['id'] ?>">
                        <div class="row">
                            <div class="input-field col s6">
                        ...
                        <div class="row">
                            <div class="input-field col s6">
                              ...
                              <label for="icon_prefix">Job</label>
                            </div>
                        ...
                        <div class="row">
                            <div class="col s12">
                              <button class="btn waves-effect waves-light cyan accent-4" type="submit" name="registrar">Update
                                <i class="material-icons right">autorenew</i>
                              </button>
                            </div>
                        </div>
                        
                        <a href="privacidad.php?id=<?= $_SESSION['id'] ?>">Privacy</a>
