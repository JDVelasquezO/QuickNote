...
<html>
    ...
    <body>
        ...
        <div class="nav-wrapper container">
          ...
          <ul id="nav-mobile" class="side-nav">
            <li><a href="../../index.html"><i class="material-icons">arrow_back</i>Home</a></li>
          </ul>
        ...
        ?>
            ...
            <div id="modal1" class="modal white">
                <div class="modal-content white">
                    ...
                    <p style="color: #e53935">Email or password is incorrect</p>
                </div>
                <div class="modal-footer white">
                    <a style="color: #e53935" href="index.php" class="modal-action modal-close waves-effect waves-green btn-flat">Ok</a>
                </div>
            </div>
    ...
    ?>
            <div id="modal1" class="modal white">
                <div class="modal-content white">
                    <h4 style="color: #e53935;">Error</h4>
                    <p style="color: #e53935">Mail is already in use</p>
                </div>
                <div class="modal-footer white">
                    <a style="color: #e53935" href="index.php" class="modal-action modal-close waves-effect waves-green btn-flat">Ok</a>
                </div>
                    ...
                    {   
                        ...
                        if ($resultado) 
                        {
                            ?>
                                <div id="modal1" class="modal white">
                                    <div class="modal-content white">
                                        <h4 style="color: #00b0ff;">¡All rigth!</h4>
                                        <p style="color: #00b0ff">Done, now log in</p>
                                    </div>
                                    <div class="modal-footer white">
                                        <a style="color: #00b0ff" href="index.php" class="modal-action modal-close waves-effect waves-green btn-flat">Ok</a>
                                    </div>
                                </div>  
                            <?php
                    ...
                    else 
                    {
                        ?>
                            <div id="modal1" class="modal white">
                                <div class="modal-content white">
                                    <h4 style="color: #e53935;">Error</h4>
                                    <p style="color: #e53935">Passwords do not match</p>
                                </div>
                                <div class="modal-footer white">
                                    <a style="color: #e53935" href="index.php" class="modal-action modal-close waves-effect waves-green btn-flat">Ok</a>
                                </div>
                ...
                else
                {
                    ?>
                            <div id="modal1" class="modal white">
                                <div class="modal-content white">
                                    <h4 style="color: #e53935;">Error</h4>
                                    <p style="color: #e53935">Password must be longer than 6 characters</p>
                                </div>
                                <div class="modal-footer white">
                                    <a style="color: #e53935" href="index.php" class="modal-action modal-close waves-effect waves-green btn-flat">Ok</a>
                                </div>
