    ...
    <body class="blue-grey lighten-5">    
        ...
        <div class="nav-wrapper container">
          ...
          <ul class="right hide-on-med-and-down">
              <li><a href="index.php"><i class="material-icons">arrow_back</i>Inicio</a></li>
          </ul>
        ...
        <div class="container">
            <div id="formContacto" class="row left">
               <form action="<?=$_SERVER['PHP_SELF']?>" method="post">
                   ...
                   <div class="row">
                    <div class="col s12">
                      <button class="btn waves-effect waves-light cyan accent-4" type="submit" name="recuperar">Recupera
...
<div id="modal1" class="modal" style="color: #0091ea;">
            <div class="modal-content">
              <h4>¡Bien hecho!</h4>
              <p>Te hemos enviado un correo con tu password</p>
            </div>
            <div class="modal-footer">
                <a style="color: #0091ea;" href="../../index.html" class="modal-action modal-close waves-effect waves-green btn-flat">Gracias</a>
            </div>
</div>
...
<div id="modal1" class="modal" style="color: red;">
            <div class="modal-content">
              <h4>¡Error!</h4>
              <p>El correo o mascota no coinciden</p>
            </div>
            <div class="modal-footer">
                <a style="color: red;" href="recuperar.php" class="modal-action modal-close waves-effect waves-green btn-flat">Reintentar</a>
            </div>
<?php
        }
    }
