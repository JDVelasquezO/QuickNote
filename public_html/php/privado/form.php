        ...
        <form action="buscar.php" method="post">
            <div class="row">
                <div class="input-field col s12">
                    ...
                    <label for="icon_prefix">Busca blog:</label>
                </div>
            ...
            <a class="btn tooltipped cyan accent-4" data-position="bottom" data-delay="50" data-tooltip="Ver los blogs" href="blogs.php">
        ...
        <div id="formContacto3" class="row center">
            <div class="row">
                <form method="post" action="insertarBlog.php" enctype="multipart/form-data">
                        ...
                        <h3 class="blue-text">Publica un nuevo blog</h3>
                        <br><br>
                        <div class="row">
                        ...
                        <div>
                            <div class="input-field col s12">
                                <button class="btn waves-effect waves-light cyan accent-4" type="submit" name="action">Enviar blog
