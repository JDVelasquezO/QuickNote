    ...
    <center>
        <div style="width: 50%;" class="card">
            ...
            <div class="card-content">
                ...
                <p><a href='nota.php?id=<?=$fila["id"]?>' class="orange-text">Hacer nota</a></p>
            </div>
        ...
        <a class='dropdown-button btn' href='#' data-activates='dropdown1'>Publicaciones</a>
