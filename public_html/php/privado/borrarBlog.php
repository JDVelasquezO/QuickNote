    ...
    <nav class="white" role="navigation">
        ...
        <div id="modal1" class="modal">
          <div class="modal-content">
              <h4 style="color: #00b0ff;">Blog eliminado correctamente</h4>
            <p>Tu blog se ha eliminado, ahora nadie lo podrá ver</p>
          </div>
          <div class="modal-footer">
            <a style="color: #00b0ff;" href="form.php" class="modal-action modal-close waves-effect waves-green btn-flat">Aceptar</a>
          </div>
        </div>
