...
?>
        <div id="modal1" class="modal white">
                <div class="modal-content white">
                    ...
                    <p style="color: #e53935">No hay resultados</p>
                </div>
                <div class="modal-footer white">
                    <a style="color: #e53935" href="privado.php" class="modal-action modal-close waves-effect waves-green btn-flat">Aceptar</a>
                </div>
        </div>
